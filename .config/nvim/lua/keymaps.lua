...
vim.keymap.set("n", "<leader>b1", function() harpoon.nav_file(1) end, { desc = "Go to Harpoon file 1" })
vim.keymap.set("n", "<leader>b2", function() harpoon.nav_file(2) end, { desc = "Go to Harpoon file 2" })
vim.keymap.set("n", "<leader>b3", function() harpoon.nav_file(3) end, { desc = "Go to Harpoon file 3" })
vim.keymap.set("n", "<leader>b4", function() harpoon.nav_file(4) end, { desc = "Go to Harpoon file 4" })
vim.keymap.set("n", "<leader>ba", require("harpoon.mark").add_file, { desc = "[A]dd file to Harpoon" })
