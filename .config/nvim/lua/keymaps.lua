...
vim.keymap.set("n", "<leader>ba", ":lua require('harpoon.mark').add_file()", { desc = "[A]dd file to Harpoon" })
vim.keymap.set("n", "<leader>bd", ":bd<CR>", { desc = "[D]elete (close) current buffer" })
vim.keymap.set("n", "<leader>bm", ":lua require('harpoon.ui').toggle_quick_menu()", { desc = "Toggle Harpoon [M]enu" })
