...
alisa nvim="[ -f /.dockerenv ] && /root/squashfs-root/usr/bin/nvim || docker run --interactive --rm --tty --volume ${PWD}:/workdir islasgeci/pde:latest /root/squashfs-root/usr/bin/nvim"
